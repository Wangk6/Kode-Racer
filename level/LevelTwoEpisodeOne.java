...
public class LevelTwoEpisodeOne {

	Stage stage = new Stage();
	private Pane root = new Pane();

	
	String backgroundAudio = "src/assets/Level4.mp3";
	...
	int[] lSequence = { 3, 1, 3, 0 };
	int[] translateLength = { 150, 400, 650, 400 };
	...
	private Parent createContent() {
		...
		endTile.setLayoutX(800); // STARTING POINT OF CHARACTER
		...
		root.setStyle(
				"-fx-background-image:url('assets/Level2E1.JPG');"
	...
	private void startedGame() {
		if (startedGame == true) {
			Platform.runLater(() -> new LevelTwoEpisodeOne().start());
		}
	}
