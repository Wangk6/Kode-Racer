...
public class LevelOneEpisodeTwo {
	// Keep track of if game stage was created, if so just start
	boolean startedGame = false;
	Stage stage = new Stage();

	private Pane root = new Pane();
	String backgroundAudio = "src/assets/Level2.mp3";
	...
	private Parent createContent() {
		...
		startTile.setOpacity(0.3);//starting tile see through
		...
		endTile.setOpacity(0.3);//see through closing tile

		endTile.setLayoutX(500); // STARTING POINT OF CHARACTER
		endTile.setLayoutY(600); // STARTING POINT OF CHARACTER
		// Ending Tile
		...
		root.setStyle(
				"-fx-background-image:url('assets/Level1E2.jpg');"
	...
	private void startedGame() {
		if (startedGame == true) {
			Platform.runLater(() -> new LevelOneEpisodeTwo().start());
		}
	}
