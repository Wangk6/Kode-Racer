...
public class LevelTwoEpisodeThree {
	private int setW = 50;
	private int setH = 50;
	private int strtX = 200;
	private int strtY = 200;
	...
	Sprite player1 = new Sprite(strtX, strtY, 50, 50, "random", Color.TRANSPARENT); // Keep the W & H to 25, because
																					// we're moving at 5's
	...
	int[] lSequence = { 1, 3, 0, 3, 1 };
	int[] translateLength = { 400, 250, 400, 250, 400 };
	...
	private void startedGame() {
		if (startedGame == true) {
			Platform.runLater(() -> new LevelTwoEpisodeThree().start());
		}
	}
